...
Notes: Letters must be uppercase; If there is a number in the cost, it will always be at the beginning; Colorless, 'C' mana cannot 
be used for anything other than 'C' or digits:
